# Generated by Django 4.1.2 on 2023-03-08 14:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('seatNum', models.IntegerField(blank=True, db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('nameCodeId', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tickets.resourcecode')),
            ],
            options={
