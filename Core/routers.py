...
from Core.users.views import DriversViewSet, UserViewSet, GuideViewSet, BusinessPersonViewSet
...
detRouter.register('businessPerson', BusinessPersonViewSet, basename='businessPerson')
