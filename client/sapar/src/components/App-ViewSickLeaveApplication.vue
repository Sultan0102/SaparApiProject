            ...
            <div class="row align-items-center text-center">
                <div class="mx-auto pt-5">
                    <form class="mx-auto" @submit.prevent="false">
                        <h2 class="pt-3">{{ $t('Sick Leave Application') }}</h2>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input :value="'from ' + application.applicationData.from" type="text" class="form-control" readonly disabled>
                        </div>
                        <div class="input-group mb-3">
                            <i class="bi bi-calendar my-auto ms-4 ms-sm-5"></i>
                            <input :value="'to ' + application.applicationData.to" type="text" class="form-control" readonly disabled>
                        </div>
