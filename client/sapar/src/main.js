...
[Api.auth, Api.users, Api.tickets, Api.schedules, Api.orders, Api.cachedTicketPersons, Api.ticketPersons, Api.passportTypes, Api.payments].forEach(axiosInstance => setupinterceptors(store, router, axiosInstance))
