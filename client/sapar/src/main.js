...
[Api.auth, Api.users, Api.tickets, Api.schedules, Api.orders, Api.cachedTicketPersons, Api.ticketPersons].forEach(axiosInstance => setupinterceptors(store, router, axiosInstance))
